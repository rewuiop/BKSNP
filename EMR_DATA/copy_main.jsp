...
function onInit(){
	document.getElementById('conBody').src = "/EMR_DATA/copy/copy_body.jsp?userid="+userid+"&udept="+udept;
...
<tbody><tr>
	<td align="left">
		...
		</tr><tr><td class="tabOnText"><a href="">사본발급화면 </a></td></tr></tbody></table>
		...
		<tbody><tr><td>
			<iframe name="conBody" width="1220px" height="885" id="conBody" src="" frameBorder="0" scrolling="no"></iframe>
