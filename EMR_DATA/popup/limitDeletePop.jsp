...
<%
	System.out.println("[limitDeletePop.jsp] 기록 삭제 팝업 ");
     ...
     <tr>
         <tr>
          <td style="font-size:13px;padding-left:50px;">
          	<label><input type="radio" background='#ffffff' name="comment_cd" value="1"/> 오기록 작성<br/></label>
          	<label><input type="radio" background='#ffffff' name="comment_cd" value="2"/> 기록 중복<br/></label>
          </td>
         </tr>	
         <tr>
