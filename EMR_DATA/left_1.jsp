...
<script src='/EMR_DATA/SDK/js/Left_1.js?v=1.0.1'></script>
...
<tr><td id='patiInfomation' class='l_search' style='padding:0px'>
</td></tr>
<tr><td class='l_content'>
<div style='width:390px;height:830px' id='docList' enableCheckBoxes=1></div>
</td></tr>
</table>
</body>
</html>