...
<script src='/EMR_DATA/SDK/js/Main.js?v=1.0.3'></script>
<script>
	...
	var BK_HWAN_JA;
	var BK_USER;
	var OPENDEPT = ["CM" ,"FM" ,"GS" ,"NE" ,"NP" ,"NS" ,"SP" ,"HO" ,"GE" ,"EM" ,"RT" ,"ID" ,"UR" ,"TS" ,"PD" ,"MC" ,"CV" ,"OC" ,"NN" ,"RI" ,"OL","NR","DM","OS","PS","OG","OT","RE","DS","RM","RR","PC","EO","RD","OM","AD","IH"];
	var openDeptCheck = true;

	function oninit()
	{
		if(window.navigator.appName == "Microsoft Internet Explorer" && window.navigator.appVersion.substring(window.navigator.appVersion.indexOf("MSIE") + 5, window.navigator.appVersion.indexOf("MSIE") + 7) <= 8)
		...
		if(pid=="" || pid=="null" || pid==null)
		{
			...
			{
				//pid="00056589"; //CM
				pid="01294839";//"00596722"; //02697327 테스트환자 02697336  확인 환자 :02685322 / 02543980
				//pid="01294839";
				//pid="01245809";
				deptCd="GS";
				uDeptCd="GS"; //"HI"; //"GS"; // NR 전공의 2130709 전문의 1862552, 1400004 / NS 1921684 / FM 1952898 / NP 2160002 / GS 1882447
				doctorId = "1882447";//"1505041";//"2131758";//"2170287";//"2011296";//"1991723";//"1505041"; //"1840479";
				//doctorId = "1006111";
				arrTypeVar="chosType@O$medDate@20180405$gubun@2$hyubjin@$groupDept@CV#RM#NE";
			}
		}
		...
		if(BK_HWAN_JA.length==0)
			BK_HWAN_JA = [[BK_HWAN_JA_NAME[0][0],BK_HWAN_JA_NAME[0][1],BK_HWAN_JA_NAME[0][2],'22','M','010-1234-5678',doctorId,arrTypeVarData('medDate'),deptCd,'20170101']];
		...
		addTag+= "<td><div id='rightbody_1' onclick = 'toggleLeftTD()' name='right' marginheight='0' frameborder='no' style='bordercolor:#194f9d; padding:0px; height:940px; width:10px; margin-top:0px'></div></td>"
	...
	function toggleLeftTD(){
		var toggleDiv = document.getElementById('leftbody');
